...
export class RunningLeft extends State {
    ...
    handleInput(input) {
        ...
        else if(input === 'PRESS spacebar') this.player.setState(states.ROLLING_LEFT);
    }
}
...
export class RunningRight extends State {
    ...
    handleInput(input) {
        ...
        else if(input === 'PRESS spacebar') this.player.setState(states.ROLLING_RIGHT);
    }
}
...
export class RollingLeft extends State {
    ...
    handleInput(input) {
        ...
        else if(input === 'RELEASE spacebar') this.player.setState(states.RUNNING_LEFT);
    }
}
...
export class RollingRight extends State {
    ...
    handleInput(input) {
        ...
        else if(input === 'RELEASE spacebar') this.player.setState(states.RUNNING_RIGHT);
    }
}